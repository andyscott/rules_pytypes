...
# By default all these toolchains are registered by the pytypes_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:pytypes_toolchain",
    toolchain_type = "@rules_pytypes//pytypes:toolchain_type",
)
""".format(
            platform = platform,
