...
some other ruleset that depends on rules_pytypes, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_pytypes=$(pwd)/rules_pytypes"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_pytypes` on your system will point to this folder.
...
https://github.com/andyscott/rules_pytypes/actions/workflows/tag.yaml
